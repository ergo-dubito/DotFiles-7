...
if [[ ! $(brew --version) ]]; then
  ...
  brew install awscli awsebcli coreutils ctags bash bash-completion fzf git gnutls gpg httpie hub openssl stow jq ffmpeg clojure leiningen mysql postgres imagemagick pandoc pssh pyenv pyenv-virtualenv ripgrep nodejs packer terraform youtube-dl hunspell vim z
